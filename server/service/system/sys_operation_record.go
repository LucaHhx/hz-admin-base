...
func (operationRecordService *OperationRecordService) GetSysOperationRecordInfoList(info systemReq.SysOperationRecordSearch, c *gin.Context) (list interface{}, total int64, err error) {
	limit := info.PageSize
	...
	db = db.Where("user_id = ? and method != ?", uid, "GET")
