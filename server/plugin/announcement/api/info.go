...
import (
	...
	"hz-admin-base/plugin/announcement/model/request"
...
// @Success 200 {object} response.Response{data=model.Info,msg=string} "ok"
...
func (a *info) GetInfoPublic(c *gin.Context) {
	...
	response.OkWithDetailed(gin.H{"info": "不需要鉴权的公告接口信息"}, "Success", c)
}
