...
// @Success 200 {object} response.Response{data=system.SysParams,msg=string} "ok"
...
// @Success 200 {object} response.Response{data=system.SysParams,msg=string} "Success"
...
func (sysParamsApi *SysParamsApi) GetSysParam(c *gin.Context) {
	...
	response.OkWithDetailed(params, "Success", c)
}
