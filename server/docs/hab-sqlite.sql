...
CREATE INDEX IF NOT EXISTS idx_sys_apis_deleted_at ON sys_apis (deleted_at);
...
CREATE TABLE sys_authorities (
  ...
  authority_name varchar(191) DEFAULT NULL,
  parent_id integer DEFAULT NULL,
  default_router varchar(191) DEFAULT 'userInfo',
  type integer DEFAULT '0',
  parameter text
);

CREATE UNIQUE INDEX IF NOT EXISTS uni_sys_authorities_authority_id ON sys_authorities (authority_id);
...
CREATE TABLE sys_authority_btns (
  ...
  sys_menu_id integer DEFAULT NULL,
  sys_base_menu_btn_id integer DEFAULT NULL
);
...
CREATE TABLE sys_authority_cols (
  ...
  sys_menu_id integer DEFAULT NULL,
  sys_base_menu_btn_id integer DEFAULT NULL,
  sys_table_columns_id integer DEFAULT NULL
);
...
CREATE TABLE sys_auto_code_histories (
  ...
  export_template_id integer DEFAULT NULL,
  package_id integer DEFAULT NULL
);

CREATE INDEX IF NOT EXISTS idx_sys_auto_code_histories_deleted_at ON sys_auto_code_histories (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_auto_code_packages_deleted_at ON sys_auto_code_packages (deleted_at);
...
CREATE TABLE sys_base_menu_btns (
  ...
  desc varchar(191) DEFAULT NULL,
  sys_base_menu_id integer DEFAULT NULL
);

CREATE INDEX IF NOT EXISTS idx_sys_base_menu_btns_deleted_at ON sys_base_menu_btns (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_base_menu_parameters_deleted_at ON sys_base_menu_parameters (deleted_at);
...
CREATE TABLE sys_base_menus (
  ...
  active_name varchar(191) DEFAULT NULL,
  keep_alive integer DEFAULT NULL,
  default_menu integer DEFAULT NULL,
  title varchar(191) DEFAULT NULL,
  icon varchar(191) DEFAULT NULL,
  close_tab integer DEFAULT NULL,
  transition_type varchar(191) DEFAULT NULL
);

CREATE INDEX IF NOT EXISTS idx_sys_base_menus_deleted_at ON sys_base_menus (deleted_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_sys_bind_sessions_session_token ON sys_bind_sessions (session_token);
CREATE INDEX IF NOT EXISTS idx_sys_bind_sessions_deleted_at ON sys_bind_sessions (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_data_filter_deleted_at ON sys_data_filter (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_dictionaries_deleted_at ON sys_dictionaries (deleted_at);
...
CREATE TABLE sys_dictionary_details (
  ...
  label varchar(191) DEFAULT NULL,
  value varchar(191) DEFAULT NULL,
  extend varchar(191) DEFAULT NULL,
  status integer DEFAULT NULL,
  sort integer DEFAULT NULL,
  sys_dictionary_id integer DEFAULT NULL
);

CREATE INDEX IF NOT EXISTS idx_sys_dictionary_details_deleted_at ON sys_dictionary_details (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_export_template_condition_deleted_at ON sys_export_template_condition (deleted_at);
...
CREATE TABLE sys_export_template_join (
  ...
  deleted_at datetime DEFAULT NULL,
  template_id varchar(191) DEFAULT NULL,
  joins varchar(191) DEFAULT NULL,
  "table" varchar(191) DEFAULT NULL,
  "on" varchar(191) DEFAULT NULL
);

CREATE INDEX IF NOT EXISTS idx_sys_export_template_join_deleted_at ON sys_export_template_join (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_export_templates_deleted_at ON sys_export_templates (deleted_at);
...
-- ----------------------------
BEGIN;
INSERT INTO sys_export_templates (id, created_at, updated_at, deleted_at, db_name, name, table_name, template_id, template_info, "limit", "order") VALUES (1, '2025-03-12 11:33:34.945', '2025-03-12 11:33:34.945', NULL, '', 'api', 'sys_apis', 'api', '{"path":"路径","method":"方法（大写）","description":"方法介绍","api_group":"方法分组"}', NULL, '');
COMMIT;
...
CREATE INDEX IF NOT EXISTS idx_sys_ignore_apis_deleted_at ON sys_ignore_apis (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_operation_records_deleted_at ON sys_operation_records (deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_params_deleted_at ON sys_params (deleted_at);
...
CREATE TABLE sys_table_columns (
  struct_name varchar(255) DEFAULT NULL,
  json_name varchar(255) DEFAULT NULL,
  column_name varchar(255) DEFAULT NULL,
  with int DEFAULT NULL,
  type varchar(255) DEFAULT NULL,
  sortable integer DEFAULT NULL,
  filter integer DEFAULT NULL,
  default_filter varchar(255) DEFAULT NULL,
  filter_list text DEFAULT NULL,
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  sort integer DEFAULT NULL,
  created_at datetime DEFAULT NULL,
  updated_at datetime DEFAULT NULL,
  ...
  enum text DEFAULT NULL,
  menu_id integer DEFAULT NULL,
  tb_name varchar(255) DEFAULT NULL,
  fixed varchar(255) DEFAULT NULL,
  format varchar(255) DEFAULT NULL,
  is_add_search integer DEFAULT NULL,
  search_width int DEFAULT NULL,
  is_additional integer DEFAULT NULL,
  filter_id integer DEFAULT NULL,
  form_disabled integer DEFAULT NULL,
  form_hidden integer DEFAULT NULL,
  form_with integer DEFAULT NULL,
  form_order integer DEFAULT NULL,
  is_having integer DEFAULT NULL,
  form_must integer DEFAULT NULL,
  editor_filter_id integer DEFAULT NULL,
  is_sum integer DEFAULT NULL
);

CREATE UNIQUE INDEX IF NOT EXISTS idx_table_col ON sys_table_columns (struct_name,json_name);
...
CREATE TABLE sys_users (
  ...
  nick_name varchar(191) DEFAULT '系统用户',
  header_img varchar(191) DEFAULT 'https://qmplusimg.henrongyi.top/HAB_header.jpg',
  ...
  type integer DEFAULT '0',
  parameter text,
  language varchar(191) DEFAULT 'zh-CN',
  side_mode varchar(191) DEFAULT 'dark',
  active_color varchar(191) DEFAULT '#1890ff',
  base_color varchar(191) DEFAULT '#fff',
  google_auth_enabled integer DEFAULT '0',
  google_auth_secret varchar(191) DEFAULT NULL,
  passkey_enabled integer DEFAULT '0',
  passkey_credentials text,
  passkey varchar(2000) DEFAULT NULL,
  test_passkey varchar(2000) DEFAULT NULL
);

CREATE INDEX IF NOT EXISTS idx_sys_users_deleted_at ON sys_users (deleted_at);
CREATE INDEX IF NOT EXISTS idx_sys_users_uuid ON sys_users (uuid);
