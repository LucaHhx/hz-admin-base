  ...
  <div>
    <div class="sticky top-0.5 z-10 my-4">
      <el-button
        ...
        @click="all"
      >
        {{ $t('superAdmin.authority.components.datas.selectAll') }}
      </el-button>
      <el-button
        class="float-left"
        type="primary"
        @click="self"
      >
        {{ $t('superAdmin.authority.components.datas.currentRole') }}
      </el-button>
      <el-button
        class="float-left"
        type="primary"
      ...
      >
        {{ $t('superAdmin.authority.components.datas.currentAndChildren') }}
      </el-button>
      <el-button
        class="float-right"
        type="primary"
...
const authDataEnter = async() => {
  ...
  if (res.code === 0) {
    ElMessage({ type: 'success', message: t('superAdmin.authority.components.datas.resourceSettingSuccess') })
  }
}
