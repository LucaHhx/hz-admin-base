  ...
  <div>
    <div class="hab-search-box">
      <el-form
        ...
        :model="searchInfo"
      >
        <el-form-item :label="$t('superAdmin.operation.method')">
          <el-input
            v-model="searchInfo.method"
            :placeholder="$t('superAdmin.operation.searchPlaceholder')"
          />
        </el-form-item>
        <el-form-item :label="$t('superAdmin.operation.path')">
          <el-input
            v-model="searchInfo.path"
            :placeholder="$t('superAdmin.operation.searchPlaceholder')"
          />
        </el-form-item>
        <el-form-item :label="$t('superAdmin.operation.status')">
          <el-input
    ...
    <div class="hab-table-box">
      ...
      >
        ...
        <el-table-column
          align="left"
          :label="$t('superAdmin.operation.operator')"
          width="140"
        >
        ...
        <el-table-column
          align="left"
          :label="$t('superAdmin.operation.date')"
          width="180"
        >
          <template #default="scope">
            {{
