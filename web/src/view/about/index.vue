    ...
    <div class="flex flex-col md:flex-row gap-4">
      <div class="w-full md:w-1/2">
        <el-card class="min-w-96">
          <template #header>
            <el-divider>{{ $t('about.projectTitle') }}</el-divider>
          </template>
          <div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 mt-4">
              <div
                ...
                :key="index"
                class="min-h-10 flex items-center"
              >
                <a
                  :href="item.html_url"
                ...
                >
                  <img
                    ...
                    :alt="item.login"
                  >
                  <el-link class="text-blue-700 ml-2 text-lg font-bold font-sans break-all">
                    {{ item.login }}
                  </el-link>
                </a>
              </div>
