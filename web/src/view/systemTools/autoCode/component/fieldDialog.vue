<template>
  <div>
    ...
    >
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.fieldName')"
        prop="fieldName"
      >
        <el-input
        ...
        <el-button
          ...
          @click="autoFill"
        >
          <span style="font-size: 12px">{{ $t('autoCode.component.fieldDialog.autoFill') }}</span>
        </el-button>
      </el-form-item>
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.fieldDesc')"
        prop="fieldDesc"
      >
        <el-input
      ...
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.fieldJson')"
        prop="fieldJson"
      >
        <el-input
      ...
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.columnName')"
        prop="columnName"
      >
        <el-input
      ...
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.comment')"
        prop="comment"
      >
        <el-input
      ...
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.fieldType')"
        prop="fieldType"
      >
        <el-select
          v-model="middleDate.fieldType"
          style="width: 100%"
          :placeholder="$t('autoCode.component.fieldDialog.selectFieldType')"
          clearable
          @change="clearOther"
        >
          <el-option
      ...
      <el-form-item
        :label="middleDate.fieldType === 'enum' ? $t('autoCode.component.fieldDialog.enumValues') : $t('autoCode.component.fieldDialog.dataTypeLong')"
        prop="dataTypeLong"
      >
        <el-input
          ...
          :placeholder="
            middleDate.fieldType === 'enum'
              ? $t('autoCode.component.fieldDialog.enumPlaceholder')
              : $t('autoCode.component.fieldDialog.lengthPlaceholder')
          "
        />
      </el-form-item>
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.fieldSearchType')"
      ...
      >
        <el-select
          ...
          style="width: 100%"
          :placeholder="$t('autoCode.component.fieldDialog.selectSearchType')"
          clearable
        >
          <el-option
      ...
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.dictType')"
        prop="dictType"
      >
        <el-select
          ...
          :placeholder="$t('autoCode.component.fieldDialog.selectDict')"
          clearable
        >
          <el-option
      ...
      <el-form-item :label="$t('autoCode.component.fieldDialog.defaultValue')">
        <el-input
          v-model="middleDate.defaultValue"
          :placeholder="$t('autoCode.component.fieldDialog.defaultValuePlaceholder')"
        />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.primaryKey')">
        <el-checkbox v-model="middleDate.primaryKey" />
      </el-form-item>
      <el-form-item
        :label="$t('autoCode.component.fieldDialog.indexType')"
        prop="fieldIndexType"
      >
        <el-select
          ...
          :disabled="middleDate.fieldType === 'json'"
          style="width: 100%"
          :placeholder="$t('autoCode.component.fieldDialog.selectIndexType')"
          clearable
        >
          <el-option
      ...
      <el-form-item :label="$t('autoCode.component.fieldDialog.frontendEdit')">
        <el-switch v-model="middleDate.form" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.frontendTable')">
        <el-switch v-model="middleDate.table" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.frontendDetail')">
        <el-switch v-model="middleDate.desc" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.importExport')">
        <el-switch v-model="middleDate.excel" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.sort')">
        <el-switch v-model="middleDate.sort" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.required')">
        <el-switch v-model="middleDate.require" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.clearable')">
        <el-switch v-model="middleDate.clearable" />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.hideSearchCondition')">
        <el-switch
          v-model="middleDate.fieldSearchHide"
          :disabled="!middleDate.fieldSearchType"
        />
      </el-form-item>
      <el-form-item :label="$t('autoCode.component.fieldDialog.validationText')">
        <el-input v-model="middleDate.errorText" />
      </el-form-item>
    </el-form>
    <el-collapse v-model="activeNames">
      <el-collapse-item
        :title="$t('autoCode.component.fieldDialog.dataSourceConfig')"
        name="1"
      >
        <el-row :gutter="8">
          <el-col :span="4">
            <el-select
              ...
              :placeholder="$t('autoCode.component.fieldDialog.database')"
              clearable
              @change="dbNameChange"
            >
              <el-option
          ...
          <el-col :span="4">
            <el-select
              ...
              :placeholder="$t('autoCode.component.fieldDialog.associationMode')"
              @change="associationChange"
            >
              <el-option
                :label="$t('autoCode.component.fieldDialog.oneToOne')"
                :value="1"
              />
              <el-option
                :label="$t('autoCode.component.fieldDialog.oneToMany')"
                :value="2"
              />
            </el-select>
          </el-col>
          <el-col :span="5">
            <el-select
              ...
              :placeholder="$t('autoCode.component.fieldDialog.sourceTable')"
              filterable
              allow-create
              clearable
          ...
          <el-col :span="5">
            <el-select
              ...
              :placeholder="$t('autoCode.component.fieldDialog.storeData')"
            >
              <template #label="{ value }">
                <span>{{ $t('autoCode.component.fieldDialog.store') }}: </span>
              ...
              >
                <span style="float: left">
                  <el-tag :type="item.isPrimary ? 'primary' : 'info'">
                    {{ item.isPrimary ? $t('autoCode.component.fieldDialog.primaryKeyTag') : $t('autoCode.component.fieldDialog.nonPrimaryKeyTag') }}
                  </el-tag>
                ...
                <span
                  ...
                  "
                >
                  {{ $t('autoCode.component.fieldDialog.typeLabel') }}：{{ item.type }}
                  <span v-if="item.comment != ''">，{{ $t('autoCode.component.fieldDialog.fieldDescription') }}：{{ item.comment }}</span>
                </span>
              </el-option>
            </el-select>
          </el-col>
          <el-col :span="5">
            <el-select
              ...
              :placeholder="$t('autoCode.component.fieldDialog.selectDisplayData')"
            >
              <template #label="{ value }">
                <span>{{ $t('autoCode.component.fieldDialog.display') }}: </span>
                <span style="font-weight: bold">{{ value }}</span>
              </template>
              <el-option
                v-for="item in dbColumnList"
