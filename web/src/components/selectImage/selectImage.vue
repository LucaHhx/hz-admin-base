<template>
  <div>
    <selectComponent
      ...
      :rounded="rounded"
      :model="model"
      @choose-item="openChooseImg"
      @delete-item="openChooseImg"
    />
    <div
      v-else
    ...
    <el-drawer
      v-model="drawer"
      title="媒体库 | 点击“文件名”可以编辑，选择的类别即是上传的类别"
      :size="880"
    >
      <div class="flex">
        <div
          ...
          <el-scrollbar style="height: calc(100vh - 110px)">
            ...
            >
              <template #default="{ node, data }">
                <div
                  class="w-36"
                  :class="search.classId === data.ID ? 'text-blue-500 font-bold' : ''"
                >
                  {{ data.name }}
                </div>
                <el-dropdown>
        ...
        <div class="ml-4 w-[605px]">
          ...
          <div class="hab-btn-list gap-2">
            <el-button
              ...
              :icon="ArrowLeftBold"
              @click="useSelectedImages"
            >
              选定
            </el-button>
            <upload-common
              :image-common="imageCommon"
              :class-id="search.classId"
          ...
          <div class="flex flex-wrap gap-4">
            ...
            >
              ...
              <div
                class="overflow-hidden text-nowrap overflow-ellipsis text-center w-full cursor-pointer"
    ...
    >
      ...
      <template #footer>
        <el-button @click="closeAddCategoryDialog">
          取消
        </el-button>
        <el-button
          type="primary"
